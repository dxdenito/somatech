...
?>
		...
		<html>
	<head>
		<title>Somatech- <?php echo $row['article_title']?></title>
		<meta charset="utf-8">
...
<body>
    ...
    <div class="float-md-left">
    	<div><h3><?php echo $row['article_title']?></h3></div>
    	<small>~posted <?php echo date('jS M Y',$row['article_id']);?></small>
    	<div><p id="content"><?php echo $row['article_content']?><p></div>
    	<div><a href="index.php">&larr; Back</a></div>
